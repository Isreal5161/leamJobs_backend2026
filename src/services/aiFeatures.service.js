...
const profileAssistantResponseContract = [
  ...
  '- for Profile Summary, when enough factual information is available, aim for approximately 80-150 words; do not mechanically pad to reach 80 words',
  '- for Profile Summary, prefer a meaningful summary that uses the user\'s real professional title, work experience, responsibilities, skills, education, certifications, actual achievements, and career direction when supplied',
  '- for Profile Summary, if the profile is limited, produce the strongest useful summary available from the supplied facts without inventing substance',
  '- for Profile Summary, do not return generic one-sentence summaries, empty buzzwords, repetitive statements, meaningless adjectives, or unsupported claims',
